			...
			<div class="row">
				...
				<div class="mt-5 col-10 offset-1">
					<form:form
						...
						method="POST"
						action="/SOF3021_Asm/admin/products/update/${ product.id }">
						<div class="form-group mt-3">
							<label for="name">ID</label>
						    <form:input path="id" class="form-control" value="${ product.id }" readonly="true"  />
						</div>
						<div class="form-group mt-3">
						...
						<div class="form-group mt-3">
							<label for="category.id">Image</label>
							<form:input path="image" value="${image}" id="image" name="image" class="form-control" type="file" />
						</div>
						<div class="form-group mt-3">
							<label for="password">Price</label>
							<form:input path="price" value="${product.price }" name="price" class="form-control" />
						</div>
						<div class="form-group mt-3">
							<label>Ngày Tạo:
							<fmt:formatDate pattern = "yyyy-MM-dd" value = "${product.createdDate}" />
							</label>
						</div>
						<div class="form-group mt-3">
							<label>Available</label>
							<form:select path="available" class="form-control" value="${product.available }">
						...
						<%-- <div class="form-group mt-3">
							...
							<form:select
								name="category.id"  path="category.id">
						...
						<div class="form-group mt-3">
							...
							<form:input path="category.id" value="${cate.id }" id="category.id" name="category.id" class="form-control"  readonly="true"/>
						</div>
						<div class="form-group mt-3">
