...
<body>
	<div class="container">
		...
		<div class="container">
			<div class="row">
				<div class="mt-3">
					<a class="btn btn-success" href="/SOF3021_Asm/admin/products/create">Thêm
						Mới</a>
				</div>
				<table class="table">
					<thead>
					...
					<c:forEach items="${ data.content }" var="pro">
						<tr>
							...
							<td>${ pro.name }</td>
							<td> 
								<img alt="" src="/SOF3021_Asm/images/clothes/${ pro.image }" style="width: 80px" height="70px" />							
							 </td>
							<td>${ pro.price }</td>
							...
							<td>
								<a href="/SOF3021_Asm/admin/products/edit/${ pro.id }" class="btn btn-primary">Update</a>
							</td>
							<td>
									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-footer">
												...
												<a href="/SOF3021_Asm/admin/products/delete/${ pro.id }">
			...
			<div class="row">
				...
				<c:forEach var="i" begin="0" end="${ data.totalPages -1 }">
					<li class="page-item">
						<a class="page-link"
							href="/SOF3021_Asm/admin/products/index?page=${ i }">
							${ i + 1 }
						</a>
					</li>
				</c:forEach>
