...
<body>
	<div class="container">
		...
		<div class="container">
			<div class="row">
				<div class="mt-3">
					<a class="btn btn-success" href="/SOF3021_Asm/admin/accounts/create">Thêm
						Mới</a>
				</div>
				<table class="table">
					<thead>
					...
					<c:forEach items="${ data.content }" var="acc">
						<tr>
							...
							<td>${ acc.email }</td>
							<td>
								<img alt="" src="/SOF3021_Asm/images/clothes/${ acc.photo }" style="width: 80px" height="70px" />
							</td>
							<td>${ acc.activated == 0 ? "Not Active" : "Active" }</td>
							<td>${ acc.admin == 1 ? "Admin" : "Member" }</td>
							<td>
								<a href="/SOF3021_Asm/admin/accounts/edit/${ acc.id }" class="btn btn-primary">Update</a>
							</td>
									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-footer">
												...
												<a href="/SOF3021_Asm/admin/accounts/delete/${ acc.id }">
			...
			<div class="row">
				...
				<c:forEach var="i" begin="0" end="${ data.totalPages - 1 }">
					<li class="page-item">
						<a class="page-link"
							href="/SOF3021_Asm/admin/accounts/index?page=${ i }">
							${ i + 1 }
						</a>
					</li>
				</c:forEach>
