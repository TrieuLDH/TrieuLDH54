...
<body>
	<div class="container">
		...
		<div class="container">
			<div class="row">
				<div class="mt-3">
					<a class="btn btn-success" href="/SOF3021_Asm/admin/categories/create">Thêm
						Mới</a>
				</div>
				<table class="table">
					<thead>
					...
					<c:forEach items="${ data.content }" var="cate">
						<tr>
							...
							<td>${ cate.name }</td>
							<td>
								<a href="/SOF3021_Asm/admin/categories/edit/${ cate.id }" class="btn btn-primary">Update</a>
							</td>
									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-footer">
												...
												<a href="/SOF3021_Asm/admin/categories/delete/${ cate.id }">
			...
			<div class="row">
				...
				<c:forEach var="i" begin="0" end="${ data.totalPages -1 }">
					<li class="page-item">
						<a class="page-link"
							href="/SOF3021_Asm/admin/categories/index?page=${ i }">
							${ i + 1 }
						</a>
					</li>
				</c:forEach>
