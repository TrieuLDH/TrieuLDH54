...
<body>
	<div class="container">
		...
		<div class="container">
			<div class="row">
				<h3 class="text-center mt-3">Sửa Thông Tin Danh Mục</h3>
				<div class="mt-5 col-10 offset-1">
					<form:form
						modelAttribute="cate"
						method="POST"
						action="/SOF3021_Asm/admin/categories/update/${ cate.id }">
						<div class="form-group mt-3">
							<label for="name">ID</label>
						    <form:input path="id" class="form-control" value="${ cate.id }" readonly="true"  />
						</div>
						<div class="form-group mt-3">
